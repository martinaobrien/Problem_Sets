...
if num >= 0:
    #integer has to be greater than 0, the if statement investigates whether an argument is trus
    print (format(math.sqrt(num), '.2f'))  
    # give 2 digits after the point
else:
    print ('This is not a positive number') 
    # else statement will be executed if the if statement if proved to be false
